...
mavenPublishing {
    ...
    signAllPublications()
    pom {
        name.set("kotlin-data-ref")
        description.set("kotlin-data-ref")
        url.set("https://github.com/wabbit-corp/kotlin-data-ref")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-data-ref")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-data-ref.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-data-ref.git")
        }
    }
}
...
kover {
    ...
    //             // title.set("kotlin-data-ref Code Coverage") // Uncomment to customize title
    //         }
    //         xml {
...
dokka {
    moduleName.set("kotlin-data-ref")
    ...
    dokkaSourceSets.main {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-data-ref/tree/master/src/main/kotlin")

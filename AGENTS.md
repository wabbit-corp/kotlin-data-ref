...
- Canonical repo target: `kotlin-data-ref`. Useful entrypoints: `dev project show kotlin-data-ref`, `dev build kotlin-data-ref`, `dev check kotlin-data-ref`.
- Setup-managed files are regenerated with `dev setup kotlin-data-ref`; avoid hand-editing stamped generated files.
